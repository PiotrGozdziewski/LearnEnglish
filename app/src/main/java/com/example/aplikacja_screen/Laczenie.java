...
public class Laczenie extends AppCompatActivity {
    ...
    private static final String TAG = "Laczenie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (brakujaceLiteryET.getText().toString().equals(brakujaceLitery)) {
                    ...
                    podpowiedzButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            AlertDialog alertDialog = new AlertDialog.Builder(Laczenie.this).create();
        ...
        dalejButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (i == 9) {
                    zapisz_statytyski();
                    startActivity(new Intent(Laczenie.this, WyborKategorii.class));
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(Laczenie.this, BocznyPasekLewy.class));
    }
}
